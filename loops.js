...
//? Цикл в JavaScript - это способ повторять выполнение одних и тех же действий несколько раз.

// Цикл for: Используется для выполнения блока кода определенное количество раз. Он обычно используется, когда количество итераций заранее известно.

// Цикл while: Выполняет блок кода, пока указанное условие истинно. Он обычно используется, когда количество итераций заранее неизвестно, и цикл должен продолжаться до тех пор, пока условие выполняется.

// Цикл do...while: Этот цикл очень похож на цикл while, за исключением того, что он гарантирует выполнение блока кода как минимум один раз, даже если условие ложно.
